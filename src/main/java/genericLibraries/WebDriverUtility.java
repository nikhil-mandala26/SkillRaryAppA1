...
public class WebDriverUtility {
	...
	/**
	 * This method is used to to wait until the web page appears 
	 * @param title
	 * @param time
	 * @return
	 */
	...
	/**
	 * This method is used to darg and drop an element
	 * @param element
	 * @param target
	 */
	 ...
	 * @param jutil
	 */
	public void takeSceenshot(WebDriver driver,String className,JavaUtility jutil) {
